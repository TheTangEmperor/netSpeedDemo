...
public class JConfig {
    public static final int IL_LOADING_RES = MyLoader.Options.NO_RES;//默认加载中的资源id
    public static final int IL_ERROR_RES = MyLoader.Options.NO_RES;//默认加载失败的资源id
    ...
    public static final int DEFAULT_CONNECT_TIMEOUT = 5;//默认超时时间
    public static final int DEFAULT_READ_TIMEOUT = 60;//默认读取超时时间
