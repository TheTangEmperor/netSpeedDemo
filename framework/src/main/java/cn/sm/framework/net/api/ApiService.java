...
public interface ApiService {
    ...
    @POST()
    @FormUrlEncoded
    Observable<ResponseBody> post2(@Url() String url, @FieldMap Map<String, Object> maps);
    ...
    @POST()
    Observable<ResponseBody> postQueryAndBody(@Url() String url, @Body RequestBody jsonBody, @QueryMap Map<String, String> maps);

    @POST()
    Observable<ResponseBody> postQuery(@Url() String url, @QueryMap Map<String, String> maps);
    ...
    @Multipart
    @POST()
    Observable<ResponseBody> uploadImage(@Url() String url, @Part("image\"; filename=\"image" + ".jpg") RequestBody requestBody,  @QueryMap Map<String, String> maps);
    ...
    @Multipart
    @POST()
    Observable<ResponseBody> uploadFile(@Url String fileUrl, @QueryMap Map<String, String> maps, @Part MultipartBody.Part file);
