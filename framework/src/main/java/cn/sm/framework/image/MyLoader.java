...
public interface MyLoader {
    ...
    void loadNetBitmap(ImageView target, String url , Options options);
    void loadNetDrawable(Context context, String url, SimpleTarget<Drawable> target);
    ...
    void loadFileBitmap(ImageView target, File file, Options options);
    ...
    void clearDiskCache(Context context);
        ...
        class Options {
            ...
            public static Options defOption(){
